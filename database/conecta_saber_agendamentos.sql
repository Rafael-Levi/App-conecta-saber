...
CREATE TABLE `agendamentos` (
  ...
  `status` enum('SOLICITADO','CONFIRMADO','CONCLUIDO','CANCELADO') DEFAULT 'SOLICITADO',
  ...
  CONSTRAINT `agendamentos_ibfk_1` FOREIGN KEY (`id_aluno`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `agendamentos_ibfk_2` FOREIGN KEY (`id_oferta`) REFERENCES `ofertas_aulas` (`id`) ON DELETE CASCADE
